//
//  FormEmailSignupViewController.m
//  GoOrNo
//
...
#import "FormEmailSignupViewController.h"

@interface FormEmailSignupViewController ()

@end

@implementation FormEmailSignupViewController
...
- (void)viewDidLoad {
  ...
  self.txtEmail.text = self.txtEmail.text = self.txtPassword.text = self.txtConfirmPassword.text = @"";
}
